package org.usfirst.frc.team4750.vision;
...
public class GripPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double[] hslThreshold0Hue = {0.0, 30.254668930390498};
		double[] hslThreshold0Saturation = {224.73021582733813, 255.0};
		double[] hslThreshold0Luminance = {80.26079136690647, 177.07130730050935};
		...
		double[] hslThreshold1Hue = {106.83453237410072, 149.4397283531409};
		double[] hslThreshold1Saturation = {222.43705035971223, 255.0};
		double[] hslThreshold1Luminance = {80.26079136690647, 177.07130730050935};
		hslThreshold(hslThreshold1Input, hslThreshold1Hue, hslThreshold1Saturation, hslThreshold1Luminance, hslThreshold1Output);

		// Step CV_subtract0:
		Mat cvSubtractSrc1 = hslThreshold1Output;
		Mat cvSubtractSrc2 = hslThreshold0Output;
		cvSubtract(cvSubtractSrc1, cvSubtractSrc2, cvSubtractOutput);

		// Step Blur0:
		Mat blurInput = cvSubtractOutput;
		BlurType blurType = BlurType.get("Gaussian Blur");
		double blurRadius = 1.6318204997450279;
		...
		double[] filterContoursSolidity = {5.649717514124294, 100};
